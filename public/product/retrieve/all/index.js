    ...
    fetch('/products', {
        ...
        .then(function (body) {
            ...
            products.forEach(function (product) {
                ...
                const favoriteVolumeCell = document.createElement("td");
                ...
                favoriteVolumeCell.textContent = product.favoriteVolume + `\n(${product.numOfFavorites})`;
                ...
                addFavouriteButton.addEventListener('click', function () {
                    localStorage.setItem("favouriteProductId", product.productId);
                ...
                addToCartButton.addEventListener('click', function () {
                    localStorage.setItem("cartProductId", product.productId);
                ...
                row.appendChild(favoriteVolumeCell);
